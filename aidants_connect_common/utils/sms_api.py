...
#             if setting.startswith("LM_") and not f"{getattr(settings, setting)}".strip() # noqa: 501
#         ]:
#             only_one = len(lm_settings) == 1
#             message = (
#                 "SMS API is disabled because environment variable {} is not set."
#                 if only_one
#                 else "SMS API is disabled because environment variables {} are not set." # noqa: 501
