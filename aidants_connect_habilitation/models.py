...
class OrganisationRequest(models.Model):
    ...
    # Manager
    manager_first_name = models.CharField("Prénom", max_length=150)
    manager_last_name = models.CharField("Nom", max_length=150)
    manager_email = models.EmailField(max_length=150)
    manager_profession = models.CharField(
        "Intitulé du poste", blank=False, max_length=150
    )
    manager_phone = PhoneNumberField(blank=True)
