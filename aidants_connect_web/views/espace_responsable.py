...
class AddAidantProfileChoiceView(AddAidantWizardMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        if profile == AddAidantProfileChoice.NOT_YET_TRAINED:
            return redirect(reverse("espace_responsable_aidant_new_untrained"))
        return redirect(reverse("espace_responsable_aidant_new_trained"))
...
class AddAidantTrainedView(AddAidantWizardMixin, TemplateView):
    ...
    def _guard_profile_or_redirect(self):
        if self._profile_choice() != AddAidantProfileChoice.ALREADY_TRAINED:
            self._clear_wizard()
            return redirect(reverse("espace_responsable_aidant_new_profile"))
        return None
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect(reverse("espace_responsable_aidant_new_confirmation"))
...
class AddAidantUntrainedView(AddAidantWizardMixin, FormView):
    ...
    def _back_url(self):
        return reverse("espace_responsable_aidant_new_profile")
...
class AddAidantConfirmationView(AddAidantWizardMixin, TemplateView):
    ...
    def _back_url(self):
        profile = self._profile_choice()
        if profile == AddAidantProfileChoice.NOT_YET_TRAINED:
            return reverse("espace_responsable_aidant_new_untrained")
        return reverse("espace_responsable_aidant_new_trained")
...
class CancelHabilitationRequestView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect(reverse("espace_responsable_aidants"))
