...
class HabilitationRequestsResourceExportTestCase(TestCase):
    ...
    def test_export(self):
        ...
        self.assertEqual(len(data), 2)
        self.assertEqual(data[0][11], "Homer")
        self.assertEqual(data[0][16], "Marseille")
        self.assertEqual(data[0][17], "")
        self.assertEqual(data[0][18], "")
        self.assertEqual(data[1][11], "Bowser")
        self.assertEqual(data[1][17], "Bouches-du-Rhône")
        self.assertEqual(data[1][18], "Provence-Alpes-Côte d'Azur")
