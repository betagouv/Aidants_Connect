...
class HabilitationRequestsTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.add_aidant_url = reverse("espace_responsable_aidant_new_profile")
        cls.add_aidant_trained_url = reverse("espace_responsable_aidant_new_trained")
        cls.add_aidant_untrained_url = reverse(
            "espace_responsable_aidant_new_untrained"
        )
        cls.add_aidant_confirmation_url = reverse(
            "espace_responsable_aidant_new_confirmation"
        )
