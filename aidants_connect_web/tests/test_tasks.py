    ...
    def test_export_for_bizdevs(self):
        ...
        self.assertEqual(
            dedent(
                ...
                Thierry,Goneau,{self.staff_aidant.email},,Formation entre pairs,secrétaire,{self.staff_aidant.created_by_fne},{self.staff_aidant.id_fne},{self.staff_aidant.updated_at.strftime("%d-%m-%Y")},,False,True,False,False,None,None,None,False,True,,,,Org Formation,False,5,2,0,0,0,COMMUNE D'HOULBEC COCHEREL,None,{self.staff_aidant_org.created_by_fne},123,45 avenue du Général de Gaulle,27120,HOULBEC COCHEREL,27,27,Réseau France Services,False,0,None,None,None,4
                """  # noqa: E501
            ).strip(),
