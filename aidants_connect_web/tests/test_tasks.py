...
class ExportForBizdevs(TestCase):
    ...
    def test_export_for_bizdevs(self):
        ...
        self.assertEqual(
            dedent(
                f"""
                prénom,nom,adresse électronique,Téléphone,profession,Est référent,Aidant - Peut créer des mandats,Carte TOTP active,Carte TOTP décallée,totp_card_drift,Date activation carte TOTP,App OTP,actif,Nombre de mandats créés,Nombre de mandats à distance créés,Nombre de mandats révoqués,Nombre de mandats renouvelés,Organisation: Nom,Organisation: Datapass ID,Organisation: N° SIRET,Organisation: Adresse,Organisation: Code Postal,Organisation: Ville,Organisation: Code INSEE du département,Organisation: Code INSEE de la région,Organisation type: Nom,Organisation: Labellisation France Services,Organisation: categorieJuridiqueUniteLegale,Organisation: Niveau I catégories juridiques,Organisation: Niveau II catégories juridiques,Organisation: Niveau III catégories juridiques,Organisation: Nombre d'usagers
                Thierry,Goneau,{self.staff_aidant.email},,secrétaire,False,True,False,None,None,None,False,True,5,2,0,0,COMMUNE D'HOULBEC COCHEREL,None,123,45 avenue du Général de Gaulle,27120,HOULBEC COCHEREL,27,27,France Services/MSAP,False,0,None,None,None,4
                """  # noqa: E501
            ).strip(),
