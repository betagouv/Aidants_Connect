    ...
    for one_sending in sendings_table:
        ...
        if db_sending is None:
            ...
            if referent is None:
                ...
                db_sending.referent = referent.referent
        ...
        if one_sending.Date_d_envoi:
            ...
            db_sending.status = SendingStatusChoices.SENDING.value
        else:
            db_sending.status = SendingStatusChoices.PREPARING.value
